...
class v8DetectionLoss:
    ...
    def __call__(self, preds, batch, teacher=None, student=None, mask=None):
        """Calculate the sum of the loss for box, cls and dfl multiplied by batch size."""
        loss = torch.zeros(4, device=self.device)  # box, cls, dfl, imit
        ...
        loss[3] = imitation_loss(teacher, student, mask) * 0.01
